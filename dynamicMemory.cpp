...
//        array.
// Param: array - pointer to the first element of an integer
//                array.
...
int main()
{
	...
	while( !done )
	{
		...
		case 1:
			...
			{
				// Ask the user to input the value the user wants to
				// assign to element 'index'.
				cout << "[" << index << "] = ";
				cin >> value;

				// Set the value the user entered to the index the
				// use specified.
				array[index] = value;
			}
			break;
